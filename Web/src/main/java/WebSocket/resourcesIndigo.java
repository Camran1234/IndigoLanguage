 ...
 * @author camran1234
 */
@WebServlet(name = "resourcesIndigo", urlPatterns = {"/resourcesIndigo"})
public class resourcesIndigo extends HttpServlet {
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String text = analysis.getLoggedUser();
            if(text==null){
                text = "";
            }
            out.println(text);
    ...
    public String getServletInfo() {
        return "Servlet for Upload Data";
    }// </editor-fold>
